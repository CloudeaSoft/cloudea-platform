...
public class CalculateUserPostInterestJob : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        foreach (var userId in userIdList) {
            ...
            var postInterestList = new List<UserPostInterest.PostInterest>();
            ...
            foreach (var postId in postIdList) {
                ...
                postInterestList.Add(new UserPostInterest.PostInterest {
                    PostId = postId,
                    Score = score
                });
            }
            ...
            _userPostInterestRepository.Add(new UserPostInterest {
                UserId = userId,
                PostInterestList = postInterestList
            });
        }
