...
namespace Cloudea.Infrastructure.Database
{
    public static class Extensions
    {
        ...
        private static Type _baseEntityType = typeof(BaseEntity);
        private static PropertyInfo _createProp = typeof(BaseEntity).GetProperty(nameof(BaseEntity.CreateTime));
        private static PropertyInfo _updateProp = typeof(BaseEntity).GetProperty(nameof(BaseEntity.UpdateTime));
        /// <summary>
