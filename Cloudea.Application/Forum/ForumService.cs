    ...
    IUserProfileRepository userProfileRepository)
{
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<Result<PageResponse<PostInfo>>> GetUserPostHistoryListAsync(PageRequest request, CancellationToken cancellationToken = default)
    {
        var userId = await _currentUser.GetUserIdAsync(cancellationToken);
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<Result<PageResponse<PostInfo>>> GetUserLikedPostListAsync(PageRequest request, CancellationToken cancellationToken = default)
    {
        var userId = await _currentUser.GetUserIdAsync(cancellationToken);
    ...
    /// </summary>
    /// <returns></returns>
    public async Task<Result<PageResponse<PostInfo>>> GetUserFavoritedPostListAsync(PageRequest request, CancellationToken cancellationToken = default)
    {
        var userId = await _currentUser.GetUserIdAsync(cancellationToken);
